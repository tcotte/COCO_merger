...
def run():
    parser = argparse.ArgumentParser(description='Merge two annotation files to one file')
    parser.add_argument('--src', required=True, type=str, nargs=2,
                        help='Path of two annotation files to merge')
    ...
    print("\n\nSuccessfully merged the two files ({} , {}) into {}".format(args.src[0], args.src[1], args.out))
